...
if ($_SERVER["REQUEST_METHOD"] === "POST") {
    try {
        ...
        if ($_SESSION["strength"] >= 7){
            new_consultant(dbconnect_insert(), $_POST);
            $_SESSION["usermessage"]="SUCCESS: consultant created!";
            consultantauditor(dbconnect_insert(),getnewconsultantid(dbconnect_select(),$_POST["username"]),"reg","created new consultant ");
            echo user_message();
        }else{
        ...
        $_SESSION["usermessage"]="ERROR: Could not create consultant: ".$e->getMessage();
        throw $e;
    }
