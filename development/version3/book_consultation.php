        ...
        echo "<div class ='content'>"; // class context to give all items that give information an overall css to reduce need for styling later and standardise formatting
            ...
            elseif ($_SERVER["REQUEST_METHOD"] === "POST") {// checks request method
                ...
                if(create_consultation(dbconnect_insert(), $epoch)){
                    ...
                    auditor(dbconnect_insert(),$_SESSION['userid'],"bok","created new consultation"); // audits information into audit log
            ...
            echo "<form method='post' action=''>";// opens a form
                ...
                echo "<select name='consultant'>";
                    ...
                    foreach ($consultants as $name){
                        ...
                        echo "<option  value =".$name['consultantid'].">".$name['consultant_name']."</option>"; // displays consultant name and assigns it the value of the consultants id when selected
