...
echo "<div class ='slogan'>";
    echo "<div id ='sloganmain'>"."PROTECTING THE WORLD"."</div>";
    echo "<hr>";
    echo "<div id ='slogansub'>"."Reduce "."<span id='grey'>Costs</span> | Think "."<span id='grey'>Smarter</span> | Green "."<span id='grey'>Energy</span>"."</div>";
echo "</div>";
if (!$message){
    echo user_message();
}else{
